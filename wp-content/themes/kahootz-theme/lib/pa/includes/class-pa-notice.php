...
class Pa_Notice
{
   ...
   * @access private
   */
  private static $notice_meta_key = '_dismissed_pa_notices';
  ...
  public static function _construct()
  {
    if (is_admin())
    {
      add_action('current_screen', array('pa_notice', 'register_notice'));
      add_action('admin_notices', array('pa_notice', 'notice'));
      add_action('wp_ajax_pa_notice', array('pa_notice', 'ajax'));
    }
  }
  ...
  public static function register_notice()
  {
    ...
    pa::process_parts('notices', $data, array('pa_notice', 'register_notice_callback'));
  }
  ...
  /**
   * ajax
   * Updates the user meta field 'pa_notice_dismissed' with the notice_id
