...
class Pa_Media
{
  ...
  {
    add_action('admin_init', array('pa_media', 'init'), 50);

    add_filter('attachment_fields_to_edit', array('pa_media', 'attachment_fields_to_edit'), 100, 2);
  }
  ...
  {
    add_image_size('pa_file_preview', 96, 96, true);
  }
  ...
  public static function register_meta_boxes()
  {
    ...
    pa::process_parts('media', $data, array('pa_media', 'register_meta_boxes_callback'));
  }
  ...
  public static function meta_box($post)
  {
    if (!empty(self::$meta_boxes))
    {
      ...
      foreach (self::$meta_boxes as $meta_box)
      {
        ...
        do_action('pa_pre_render_media_meta_box', $post, $meta_box);
        ...
        do_action('pa_post_render_media_meta_box', $post, $meta_box);
