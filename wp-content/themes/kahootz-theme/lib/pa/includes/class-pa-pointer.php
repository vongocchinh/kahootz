...
class Pa_Pointer
{
  ...
  public static function _construct()
  {
    if (is_admin())
    {
      add_filter('pa_assets_localize', array('pa_pointer', 'assets_localize'));

      add_action('current_screen', array('pa_pointer', 'register_pointer'));
      add_action('admin_footer', array('pa_pointer', 'admin_footer'));
    }
  }
  ...
  public static function register_pointer()
  {
    ...
    pa::process_parts('pointers', $data, array('pa_pointer', 'register_pointer_callback'));
  }
