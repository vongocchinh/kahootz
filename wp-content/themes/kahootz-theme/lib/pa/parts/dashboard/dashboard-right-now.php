  ...
  <div class="main">
    ...
    <ul>
      ...
      <?php foreach ($post_types as $post_type) : ?>
	        ...
	        <?php $statuses = pa_cpt::get_post_statuses_for_type($post_type->name); ?>
	        ...
	        <li class="<?php echo pa::strtolower($post_type->name) . __('_right_now', 'pa');?>">
	          ...
	          <a href="<?php echo $post_type->name == 'attachment' ? 'upload.php' : 'edit.php?post_type=' . $post_type->name;?>">
	            ...
	            <?php echo $status_count . '&nbsp;' . ($status_count > 1 ? pa::pluralize($post_type->label) : $post_type->label); ?>
    ...
    <ul>
        ...
        <?php foreach ($taxonomies as $taxonomy) : ?>
          ...
          <li class="<?php echo pa::strtolower($post_type->name); ?>">
    ...
    <h4>
      ...
      <?php echo $comments->total_comments . '&nbsp;' . __('Comment(s)','pa'); ?>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="edit-comments.php?comment_status=approved">
          ...
          <?php echo $comments->approved . '&nbsp;' . __('Approved','pa'); ?>
      ...
      <li>
        ...
        <a href="edit-comments.php?comment_status=moderated">
          ...
          <?php echo $comments->moderated . '&nbsp;' . __('Pending','pa'); ?>
      ...
      <li>
        ...
        <a href="edit-comments.php?comment_status=spam">
          ...
          <?php echo $comments->spam . '&nbsp;' . __('Spam','pa'); ?>
    ...
    <h4>
      ...
      <?php echo $users['total_users'] . '&nbsp;' . __('User(s)','pa'); ?>
        ...
        <?php foreach ($users['avail_roles'] as $role => $count) : ?>
          ...
          <li class="<?php echo $role; ?>">
            ...
            <a href="users.php?role=<?php echo $role; ?>">
              ...
              <?php echo $count . '&nbsp;' . ucfirst($count > 1 ? pa::pluralize($role) : $role); ?>
    ...
    <p><?php printf(__('WordPress %1$s running %2$s theme in %3$s.','pa'), get_bloginfo('version', 'display'), $theme_name, $language); ?></p>



    <?php if (!is_network_admin() && !is_user_admin() && current_user_can('manage_options') && '1' != get_option('blog_public')) : ?>

      <?php $title = apply_filters('privacy_on_link_title', __('Your site is asking search engines not to index its content','pa')); ?>

      <?php $content = apply_filters('privacy_on_link_text' , __('Search Engines Discouraged','pa')); ?>
