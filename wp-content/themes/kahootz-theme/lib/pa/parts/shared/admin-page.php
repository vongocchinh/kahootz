<div class="wrap">
  ...
  <?php do_action('pa_admin_page_after_title'); ?>
  ...
  <?php if (isset($setting) && !empty($setting)): ?>
    ...
    <?php if ($save): ?>
      ...
      <form action="<?php echo admin_url('options.php'); ?>" method="post" enctype="multipart/form-data">
        ...
        <?php do_action('pa_pre_render_settings_form'); ?>

    <?php endif; ?>            

    <?php if ($layout == 'meta-boxes'): ?>
      
      <?php pa_setting::do_settings_sections($setting); ?>
    ...
    <?php if ($save): ?>
        ...
        <?php do_action('pa_post_render_settings_form'); ?>
        
        <?php do_action('pa_settings_form'); ?>
