    ...
    (function($)
    {
      $(document).ready(function()
      {
        $('<?php echo "#taxonomy-" . $name; ?>').append('' +
          '<label for="<?php echo "taxonomy_filter_value_" . $name; ?>"><?php _e('Filter', 'pa');?>:</label>&nbsp;' +
          ...
          '<input type="button" value="<?php _e('Reset', 'pa');?>" id="<?php echo "taxonomy_filter_reset_" . $name; ?>" name="<?php echo "taxonomy_filter_reset_" . $name; ?>" class="button <?php echo "taxonomy_filter_reset" ?>"/>'
        );
