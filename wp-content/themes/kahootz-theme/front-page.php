<?php get_header(); ?>
  ...
  <!-- <div style="margin-bottom: 48px;" bis_skin_checked="1"> -->
    <style>
      /* Font definitions */
      /* cyrillic-ext */
      @font-face {
    ...
    <!-- <div class="anima-badge" id="anima-badge" bis_skin_checked="1" style="display: none;">
      <a target="_blank" class="badge-button"
        href="https://www.animaapp.com/an?url=https%3A%2F%2Fwww.animaapp.com&amp;utm_content=sweet-cake-2876.preview.animaapp.io&amp;utm_medium=anima-playground&amp;utm_source=free-website-banner">
        <div class="badge-content" bis_skin_checked="1">
          <img class="badge-icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/anima-logo.svg" alt="Anima logo">
        </div>
        <div class="badge-text" bis_skin_checked="1">Built with Anima</div>
        <button class="close-button">
          <img class="close-icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/close-button.svg" alt="Close">
        </button>
      </a>
    </div> -->
  <!-- </div> -->
    <?php get_template_part('components/top/hero'); ?>
    <?php get_template_part('components/top/trusted-by'); ?>
    <?php get_template_part('components/top/stats'); ?>
    <?php get_template_part('components/top/services'); ?>
    <?php get_template_part('components/top/stuck-vs-ai'); ?>
    <?php get_template_part('components/top/case-studies'); ?>
    <?php get_template_part('components/top/testimonials'); ?>
    <?php get_template_part('components/top/process'); ?>
    <?php get_template_part('components/top/cta-banner'); ?>
<?php get_footer(); ?>